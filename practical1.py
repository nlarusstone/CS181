...
w = np.linalg.solve(np.dot(features.T, features) , np.dot(features.T, gap))
...
with open(pred_filename, 'w') as pred_fh:
    ...
    for datum in test_data:
        pred_csv.writerow([datum['id'], datum['gap']])
